-- ========== نظام سلاح متكامل للهاتف مع ضرر حقيقي ==========
-- ضع هذا الكود في Script داخل Part (spawnPart)

-- ========== إعدادات السلاح ==========
local weaponName = "AssaultRifle"
local respawnTime = 8 -- ثواني
local spawnHeight = 2

-- ========== إعدادات الضرر ==========
local damage = 25 -- ضرر لكل رصاصة
local bulletSpeed = 250
local fireRate = 0.15 -- ثانية بين كل طلقة
local range = 150 -- مسافة السلاح
local maxAmmo = 30
local reloadTime = 2
...
-- ========== دالة إنشاء واجهة الهاتف ==========
local function createMobileUI(player)
	-- إنشاء ScreenGui
	...
	-- إطار الخلفية الرئيسي
	local mainFrame = Instance.new("Frame")
	mainFrame.Size = UDim2.new(0, 200, 0, 100)
	mainFrame.Position = UDim2.new(0.5, -100, 1, -120)
	...
	reloadBar.Position = UDim2.new(0, 0, 0.5, 5)
	reloadBar.BackgroundColor3 = Color3.fromRGB(255, 100, 0)
	reloadBar.BorderSizePixel = 0
	reloadBar.Parent = mainFrame
	
	-- ========== زر إطلاق النار (دائري كبير) ==========
	...
	innerCircle.Parent = shootButton
	...
	reloadButton.Position = UDim2.new(0, 20, 1, -100)
	...
	-- مؤقت إعادة التلقيم
	local reloadTimer = Instance.new("Frame")
	reloadTimer.Size = UDim2.new(1, 0, 0, 3)
	reloadTimer.Position = UDim2.new(0, 0, 1, 0)
	reloadTimer.BackgroundColor3 = Color3.fromRGB(0, 255, 0)
	reloadTimer.BorderSizePixel = 0
	reloadTimer.Parent = reloadButton
	
	-- ========== زر التصويب (اختياري) ==========
	local aimButton = Instance.new("ImageButton")
	aimButton.Name = "AimButton"
	aimButton.Size = UDim2.new(0, 50, 0, 50)
	aimButton.Position = UDim2.new(0.5, -25, 1, -100)
	...
	aimText.Font = Enum.Font.GothamBold
	aimText.Parent = aimButton
...
-- ========== دالة إنشاء السلاح الكامل ==========
local function createWeaponTool()
	...
	handle.Name = "Handle"
	handle.Size = Vector3.new(1, 0.5, 1.5)
	...
	barrel.Name = "Barrel"
	barrel.Size = Vector3.new(0.3, 0.3, 1)
	...
	weld1.Part0 = handle
	weld1.Part1 = barrel
	weld1.C0 = barrel.CFrame:Inverse() * handle.CFrame
	weld1.Parent = barrel
	
	tool.Handle = handle
	
	-- متغيرات السلاح لكل لاعب
	local weaponData = {}
